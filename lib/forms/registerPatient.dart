...
class RegisterPatient extends StatefulWidget {
  ...
  RegisterPatient(this.email, this.phone);
  @override
  _RegisterPatientState createState() => _RegisterPatientState(email, phone);
}

class _RegisterPatientState extends State<RegisterPatient> {
  String phone, gender, covid, pass, cPass, email;
  IconData eye = Icons.visibility_off;
  bool _pass = true;
  int age;
  bool checkBoxValuePP = false, checkBoxValueTC = false, checkBOD = true;
  DateTime selectedDate;
  _RegisterPatientState(this.email, this.phone);
  File _profile;
      ...
      children: [
        ...
        () {
          if (selectedDate == null) {
            ...
            checkBOD = false;
            return Text("Please enter valide year",
                style: TextStyle(color: Colors.red));
          } else if (16 > (DateTime.now().year - selectedDate.year)) {
            checkBOD = false;
            return Text("User age must be above 16",
                style: TextStyle(color: Colors.red));
          } else {
            checkBOD = true;
            return Text(
