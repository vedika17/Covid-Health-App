...
import 'package:covid_health_app/screens/MyDoctor/MyDoctor.dart';
...
import 'package:covid_health_app/screens/Prescription/patient_read_prescription.dart';
...
import 'package:covid_health_app/screens/otherReports/reportList.dart';
import 'package:covid_health_app/screens/payment/testPayment.dart';
...
class _PatientHomeState extends State<PatientHome> {
  ...
  Widget build(BuildContext context) {
    fragment = [
      ...
      ReportList(phone),
      DoctordList(phone),
      ScheduleMainPage(phone),
      MyDoctor(phone),
      CovidKITMobile(phone),
      ...
      OtherReportList(phone),
      MyDoctorPrescription(phone),
      PatientProfilePage(phone),
      ...
      child: Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            ListTile(
                title: NavBarItem("Add Health Data"),
                leading: Icon(
                  Icons.data_usage,
                  size: 30,
                ),
                onTap: () {
                  Navigator.push(context,
                    ...
                    return HealthDataMobileWeb(phone);
                  }));
                }),
            ListTile(
            ...
            ListTile(
              ...
              onTap: () => onTap(context, 10),
            ),
            ListTile(
              title: NavBarItem("Prescription"),
              leading: Icon(
                Icons.line_style,
                size: 30,
              ),
              onTap: () => onTap(context, 11),
            ),
            ListTile(
              title: NavBarItem("Doctor's Panel"),
              leading: Icon(
                Icons.format_align_center,
                size: 30,
              ),
