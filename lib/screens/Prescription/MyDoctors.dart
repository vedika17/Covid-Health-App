...
class MyDoctorPrescription extends StatefulWidget {
  final String phone;

  MyDoctorPrescription(this.phone);

  @override
  _MyDoctorState createState() => _MyDoctorState();
}

class _MyDoctorState extends State<MyDoctorPrescription> {
  Color c;
                          ...
                          onTap: () {
                            Navigator.push(
                                ...
                                new MaterialPageRoute(
                                    builder: (context) =>
                                        PatientPrescriptionList(widget.phone,
